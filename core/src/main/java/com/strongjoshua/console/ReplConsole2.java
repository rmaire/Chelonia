...
public class ReplConsole2 extends AbstractConsole {
     ...
     * <br>Default key toggle is apostrophe: '
     *
     * @param skin Uses skins for Label, TextArea, and Table. Skin <b>must</b>
    ...
    private class ConsoleDisplay {
        ...
        ConsoleDisplay(Skin skin) {
            ...
            try {
                ...
                throw new RuntimeException("TextArea class does not support (<String>, <Skin>) constructor.");
            }
//            input.setTextAreaListener(new FieldListener());
