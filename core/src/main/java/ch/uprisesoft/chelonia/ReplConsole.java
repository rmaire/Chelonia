...
//import static com.strongjoshua.console.Console.UNLIMITED_ENTRIES;
...
//
//    private Class<? extends TextArea> textFieldClass;
...
//     * contain a font called 'default-font'.
//     * @param useMultiplexer If internal multiplexer should be used
//     * @param keyID Sets the key used to open/close the console (default is
//     * apostrophe: ')
//     * @see Console#dispose()
//     */
...
//    }
//
//    protected class ConsoleDisplay {
//
...
//
//            try {
//                input = (TextArea) ClassReflection.getConstructor(textFieldClass, String.class, TextFieldStyle.class)
//                        .newInstance("", tfs);
//            } catch (Exception e) {
...
//            if (command.trim().startsWith("to")) {
//                procDefinitionMode = true;
//            }
//
//            if (procDefinitionMode && command.trim().endsWith("end")) {
//                run(procDefinition);
//                log("Defined", LogLevel.SUCCESS);
//                procDefinition = "";
//                return;
//            }
//
//            if (procDefinitionMode) {
//                procDefinition += command;
//                System.out.println("Lines: " + command.lines().count());
//
//                display.setInputHeight((int) command.lines().count());
//                return;
//            }
//            run(command);
//        }
...
//                if (!(result.type().equals(NodeType.NIL) || result.type().equals(NodeType.NONE))) {
...
////		@Override public void keyTyped (TextArea textField, char c) {
...
//        private TextArea input;
//
//        protected KeyListener(TextArea tf) {
//            input = tf;
//        }
//
//        @Override
